...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			["Candi Devs"],
			['Syle0n',				'syl',				"Programmer and Artist",								'https://twitter.com/Syle0n',			'25BBF7'],
			['Egophobia',			'ego',				"Composer",												'https://twitter.com/egophobia115',		'29364E'],
			['foodisfood',			'foodisfood',		"Charter",												'https://youtu.be/wc_Xs6QgoJA',			'7001A5']
